...
DEFAULT_MAX_GAIN = sys.float_info.max
...
DEFAULT_BASS_BOOST_FC = 316/3 # or 105.333...
DEFAULT_BASS_BOOST_Q = math.sqrt(1/2) # or 0.707... 

DEFAULT_PEQ_OPTIMIZER_MIN_F = 20
DEFAULT_PEQ_OPTIMIZER_MAX_F = 20000
...
DEFAULT_PEAKING_FILTER_MIN_Q = math.sqrt(32/961)  # AUNBandEq has maximum bandwidth of 5 octaves which is Q of 0.182479
...
DEFAULT_SHELF_FILTER_MAX_Q = math.sqrt(1/2)  # Shelf filters start to overshoot above 0.707...
